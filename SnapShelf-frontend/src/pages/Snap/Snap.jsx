  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <section className={styles.wrapper}>
        <h1>Snap Your Item</h1>
        <p className={styles.subtitle}>Upload a clear photo of your item to get it instantly added to your inventory.</p>
      ...
      <p className={styles.helperText}>We&apos;ll detect your item, estimate quantity, and predict when things expire.</p>
      </section>
    </div>
  );
}
